...
public class DropDownListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(AddNew.checkSelected[position])
    ...
    private void setText(int position1){
        if (!AddNew.checkSelected[position1]) {
            AddNew.checkSelected[position1] = true;
            selectedCount++;
        } else {
            AddNew.checkSelected[position1] = false;
            selectedCount--;
        }
        ...
        if (selectedCount == 0) {
            ...
            for (int i = 0; i < AddNew.checkSelected.length; i++) {
                if (AddNew.checkSelected[i] == true) {
